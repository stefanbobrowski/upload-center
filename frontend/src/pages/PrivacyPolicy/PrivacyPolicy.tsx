const PrivacyPolicy = () => {
  return (
    <main>
      ...
      <p>
        We may collect information that you provide directly to us, such as when you fill out a form
        or contact us. We may also collect information automatically, such as your IP address and
        browsing behavior.
      </p>
