const Terms = () => {
  return (
    <main>
      ...
      <p>
        Welcome to our website. By accessing and using this site, you agree to
      ...
      <p>
        We will not be liable for any loss or damage of any nature arising from
        the use of this website.
      </p>
      <h2>Governing Law</h2>
      <p>
        Your use of this website and any dispute arising out of such use of the
        website is subject to the laws of the jurisdiction in which the website
        owner resides.
      </p>
    </main>
  );
